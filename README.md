...
Abaixo, a visualização do Workflow configurado e executado com sucesso no Databricks, demonstrando o encadeamento das tarefas:

![Fluxo do Job no Databricks](Job%20funcional%20-%20DataBricks.png)

### Configurações Técnicas (YAML)
As definições detalhadas de infraestrutura do Job, incluindo o cron de agendamento, fuso horário (America/Recife) e configurações de cluster, podem ser conferidas no arquivo de exportação:
- [Visualizar Configuração do Job (YAML)](./job_config.yaml)
